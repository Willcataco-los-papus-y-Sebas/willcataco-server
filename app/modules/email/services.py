...
class EmailService:
    ...
    async def send_water_bill_email(
        ...
        try:
            ...
            template_context["date"] = TimeBolivia.get_time_zone(bill_data.date, "%Y-%m-%d")
    ...
    async def send_water_payment_email(
        ...
        try:
            ...
            dump_receipt["date_created"] = TimeBolivia.get_time_zone(email_receipt.date_created, "%d/%m/%Y")
            dump_receipt["date_updated"] = TimeBolivia.get_time_zone(email_receipt.date_updated, "%d/%m/%Y  %H:%M")
