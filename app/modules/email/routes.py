...
from app.modules.email.schemas import EmailBase, EmailWaterReceiptBase, WaterBillEmailParams, ExtraPaymentEmailParams
...
@router.post("/extra-payment", status_code=status.HTTP_200_OK, response_model=IResponse)
