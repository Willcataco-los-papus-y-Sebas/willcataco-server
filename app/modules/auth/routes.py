...
from app.modules.auth.schemas import LoginResponse, LogoutResponse, TokenResponse
...
async def login(
    ...
    return await AuthController.login_with_cookie(response, session, form_data)
