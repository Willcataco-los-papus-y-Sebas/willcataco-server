...
class UserController:
    ...
    async def patch_information_user(id: int, session:SessionDep, user_info:UserPatch):
        ...
        user_username = await UserService.get_user_by_username(session, user_info.username)
    ...
    @staticmethod
    async def search_user(email: EmailStr | None, username: str | None, session: SessionDep):
